...
exports.register = function( plugin, options, next ) {
	...
	*/
	function extractCode( data, codePatterns ) {
	...
	*/
	function extractCodesAndCallTapestry( tapestryLookupDeferreds, data, codePatterns, identifier ) {
		...
		_.each( data, function( fragmentData ) {
			if ( _.isArray(fragmentData) || _.isObject(fragmentData) ) {
				extractCodesAndCallTapestry( tapestryLookupDeferreds, fragmentData, codePatterns, identifier );
			}
		} );
	...
	*/
	function makeItSo( deferred, options ) {
		...
		try {
			...
			extractCodesAndCallTapestry( tapestryLookupDeferreds, options.inputData, codePatterns, options.identifier );
