...
exports.register = function( plugin, options, next ) {
	...
	*/
	function extractCodesAndCallTapestry( tapestryLookupDeferreds, data, codePatterns ) {
	...
	*/
	function makeItSo( deferred, options ) {
		...
		try {
			...
			extractCodesAndCallTapestry( tapestryLookupDeferreds, options.inputData, codePatterns );
